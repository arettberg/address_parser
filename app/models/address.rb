class Address < ActiveRecord::Base
  ...
  validates :street_number, presence: {unless: :po_box, message: "or PO Box must be given"}
  validates :street_name,   presence: {unless: :po_box, message: "and name or PO Box must be given"}
